            ...
            <div className="row m-0">
              <div className="col-md-6 col-12">
                <div className="bg-light mt-lg-0 mt-4  px-4 py-2 rounded shadow border">
                  ...
                  <p>
                    <i className="fa fa-address-card me-2"></i> Newalal Chowk Road, Purnia <br /> Bihar 854301, India
                  </p>
                </div>
              </div>
              <div className="col-md-6 col-12">
                <div className="bg-light  mt-4 px-4 py-2 rounded shadow border">
                  ...
                  <p>
                    {" "}
                    <a className="text-dark text-decoration-none" href="tel:+91 9472679572">
                      {" "}
                      <i className="fa fa-phone me-2"></i> +91 9472679572{" "}
                    </a>{" "}
                    <br />
              ...
              <div className="col-md-6 col-12">
                <div className="bg-light px-4  mt-lg-0 mt-4 py-2 rounded shadow border">
                  ...
                  <p style={{ fontSize: "14px" }}>
                    <a className="text-dark text-decoration-none" href="mailto:manish@manishdesignstudio.in">
                      <i className="fa fa-envelope"></i> manish@manishdesignstudio.in{" "}
                    </a>

                    <br />
                    <a className="text-dark text-decoration-none" href="mailto:g.p.press85431@gmail.com">
                      <i className="fa fa-envelope"></i> g.p.press85431@gmail.com{" "}
                    </a>
                  </p>
                </div>
              </div>
            ...
            <div className="">
              ...
              <div className="row mt-3">
                <div className="col-md-6 p-0 m-0 d-flex justify-content-center   col-12">
                  <input
                    className="form-control shadow py-2 mx-2 my-2 width95 "
                ...
                <div className="col-md-6 p-0 m-0 d-flex justify-content-center col-12">
                  <input
                    className="form-control shadow p-2 mx-2 my-2 width95"
                    type="number"
                ...
                <div className="col-12 m-0 d-flex justify-content-center justify-content-lg-end p-0">
                  <button
                    className="btn shadow mt-lg-3 mt-2 mb-5 me-lg-2 width95  btn-outline-secondary"
